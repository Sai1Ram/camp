        ...
        <div className="flex-1 mx-3 xl:flex-[0.5] mt-8 xl:mt-0">
          ...
          <div className="flex flex-col items-start justify-start space-y-2">
            <p className="text-lg text-gray-300 ">
              {" "}
              - Ensuring seamless operations of clubs and festivals while
              maintaining transparency will be a top priority.
            </p>
            <p className="text-lg text-gray-300 ">
              - Establishing an inclusive club culture that welcomes both
              research and postgraduate students is an essential goal.
            </p>
            <p className="text-lg text-gray-300 ">
              - Encouraging clubs to frequently conduct in-house competitions
            ...
            <p className="text-lg text-gray-300 ">
              ...
              hiatus, providing a platform for the creative minds of NITR to
              flourish.
            </p>
            <p className="text-lg text-gray-300 ">
              - Prioritize transparent budget allocation for all events and
              activities.
            </p>
            {/* <p className='text-lg text-gray-300 '>.
