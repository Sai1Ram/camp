        ...
        <div className="flex-1 mx-3 xl:flex-[0.5] mt-8 xl:mt-0">
          ...
          <div className="flex flex-col items-start justify-start space-y-2">
            <p className="text-lg text-gray-300 ">
              {" "}
              - A well-structured financial plan should be devised for various
              clubs and festivals, aligning with their specific needs and
              requirements.
            </p>
            <p className="text-lg text-gray-300 ">
              - Ensuring smooth functioning of club activities and maintaining a
              positive relationship with the Student Activities Committee (SAC).
            </p>
            <p className="text-lg text-gray-300 ">
              - During the current session, our aim is to elevate the Celebrity
              Night to new heights and showcasing Roots and Jashn in a
              magnificent and grandiose fashion.
            </p>
            <p className="text-lg text-gray-300 ">
              - I am committed to fostering a multicultural environment by
              showcasing cultural events from various states of India.
            </p>
            <p className="text-lg text-gray-300 ">
              - My goal is to take the Film and Music Society to the next level
              of vibrancy.
            </p>
            {/* <p className='text-lg text-gray-300 '>
