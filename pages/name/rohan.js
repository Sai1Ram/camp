      ...
      <div className="max-w-7xl flex flex-col-reverse xl:flex-row relative  mx-auto pt-44 z-50">
        ...
        <div className="flex-1 mx-3 xl:flex-[0.5] mt-8 xl:mt-0">
          ...
          <div className="flex flex-col items-start justify-start space-y-2">
            ...
            <p className="text-lg text-gray-300 ">
              - Ensuring the seamless organization of the Cosmopolitan fest and
              Celebrity Night event will be one of my top priorities.
            </p>
            <p className="text-lg text-gray-300 ">
              - As a bridge between SAC and students, I will facilitate the
              equitable distribution of the allocated budget to all clubs and
              events under our society, ensuring transparency in the process.
            </p>
            <p className="text-lg text-gray-300 ">
              - My endeavor will be to provide clubs with well-equipped practice
              rooms and necessary equipment to support their growth and
              development.
            </p>
            {/* <p className='text-lg text-gray-300 '>
