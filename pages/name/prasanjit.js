        ...
        <div className="flex-1 mx-3 xl:flex-[0.5] mt-8 xl:mt-0">
          <div className="text-4xl md:text-5xl text-left leading-[3.4rem] font-medium">
            <p>
              ...
              <span className="text-red-500">
                {capitalizeFirstLetter("prasanjit")}
              </span>
              , an aspiring student,{" "}
            </p>
          ...
          <div className="flex flex-col items-start justify-start space-y-2">
            <p className="text-lg text-gray-300 ">
              {" "}
              - Special focus must be given to dormant clubs and attentively
              address their concerns.
            </p>
            <p className="text-lg text-gray-300 ">
              - Prioritize transparency to ensure clubs and fests operate
              smoothly.
            </p>
            <p className="text-lg text-gray-300 ">
              - Foster an inclusive club environment that welcomes postgraduate
            ...
            <p className="text-lg text-gray-300 ">
              - Infuse full enthusiasm into Celebrity Nights, Roots & Jashn,
              rekindling their vibrant vibes.
            </p>
            <p className="text-lg text-gray-300 ">
