        ...
        <div className='w-full h-fit  -mt-10 lg:-mt-24 xl:-mt-40 max-w-7xl mx-auto text-gray-300 '>
            <div className='flex flex-col items-center justify-center px-0 lg:px-32 xl:px-44 bg-cover z-50 bg-[url("/bg.png")] w-full h-[28rem] '>
                ...
                <div className='mt-6 relative'>
                    <button onClick={increaseCounter} disabled={isClicked} className={`px-3 py-2 rounded-lg w-64 hover:opacity-80 ${!click ? "bg-[#FF4C29]" : "bg-gray-400"} font-medium text-black`}><span>{!click ? "Support by Liking here 😃" : "Thanks for Liking 😊"}</span>  <span> {click && "|"} {click && (count+ 479)}</span>
                    {/* onClick={increase} */}
                    </button>
                </div>
            </div>
